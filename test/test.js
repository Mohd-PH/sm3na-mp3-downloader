...
describe('downloader', function () {
  it('downloads Sayed Darwish songs to a given location', async function () {
    this.timeout(10000);
    ...
    const songs = [{
        name: 'شد الحزام',
        link: 'https://ms2.sm3na.com/124/Sm3na_com_16171.mp3'
      },
      {
        name: 'قوم يا مصري',
        link: 'https://ms2.sm3na.com/124/Sm3na_com_16176.mp3'
      },
      {
        name: 'والله تستاهل',
        link: 'https://ms2.sm3na.com/124/Sm3na_com_16172.mp3'
      }
    ]
